...
I have set up a git hub actions CI pipeline that will build 3 images on commit to the main branch in this repo and push them to docker hub. End users can stand up a local environment using the docker compose file by running 
